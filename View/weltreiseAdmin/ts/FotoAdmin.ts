module FotoAdmin {
    export class FotoAdminManager {

        public static showPage() {

            CommonFunctions.Functions.DoAjaxGet('../REST/api/v1/I_FotoAdmin/Show',
                function (data) {
                    $("#maincontentArea").html(data);
                    FotoAdminManager.addEventListener("upload");
                    /// Content in Seite laden.
        ...
        private static addEventListener(siteID) {
            if (siteID === "upload") {
        ...
        private static addAdminEventListeners() {
        ...
        private static addEventComboChildsEvent() {
        ...
        private static addEventPicturesEventListener() {
        ...
        private static addUploadEventListeners() {
        ...
        private static addAdminViewEvents() {

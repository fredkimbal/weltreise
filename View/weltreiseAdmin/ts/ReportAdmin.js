...
(function (ReportAdmin) {
    var ReportAdminManager = (function () {
        function ReportAdminManager() {
        }
        ReportAdminManager.showPage = function () {
            CommonFunctions.Functions.DoAjaxGet('../REST/api/v1/I_ReportAdmin/Show', function (data) {
                ...
                $(".galleryComboChild").click(function (e) {
                    CommonFunctions.Functions.
                        ...
                        + e.target.getAttribute("data-galleryid"), function (data) {
                        ...
                        $(".imagepreviewpic").click(function (e) {
                            ...
                            CommonFunctions.Functions.DoAjaxGet("../REST/api/v1/I_ReportAdmin/Image/detail/" + id + "/" + $("#currentReportID").html(), function (data) {
                                ...
                                $("#SaveImageInReportBtn").click(function () {
                                    CommonFunctions.Functions.DoAjaxPost("../REST/api/v1/I_ReportAdmin/Image/save", $("#imageDetailForm").serialize(), function () {
        ...
        return ReportAdminManager;
    }());
    ReportAdmin.ReportAdminManager = ReportAdminManager;
